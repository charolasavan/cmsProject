  ...
  return (
    <>
      <nav className={`sidebar ${isOpen ? '' : 'hidden'}`}>
        ...
        <NavLink to="/coupon" end onClick={handleClick} className={({ isActive }) => isActive ? 'active' : ''}> <div className='d-flex align-items-center'> <BiSolidCoupon /> <span className='ms-2'>Coupons</span></div></NavLink>
      </nav>
